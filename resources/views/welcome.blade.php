        ...
        <div class="relative flex justify-center min-h-screen py-4 bg-gray-100 items-top dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex py-4">
                    <a
                        href="/pokemons"
                        class="px-4 py-2 mr-3 font-semibold text-white capitalize bg-red-500 rounded shadow-sm hover:bg-red-600 focus:bg-red-700"
                    >The Laravel Way</a>

                    <a
                        href="/livewire"
                        class="px-4 py-2 font-semibold text-white capitalize bg-indigo-500 rounded shadow-sm hover:bg-indigo-600 focus:bg-indigo-700"
                    >The Livewire Way</a>
                </div>
